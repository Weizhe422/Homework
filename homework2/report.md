...
| 測試案例 | 輸入參數 | 預期輸出 | 實際輸出 |
|---|---|---|---|
| 測試一 | A: 3 項 → (3,2)、(2,1)、(1,0)<br>B: 3 項 → (2,5)、(3,1)、(1,0) | A(x)=3x^2+2x+1<br>B(x)=2x^5+3x+1 | A(x)=3x^2+2x+1<br>B(x)=2x^5+3x+1 |
|  |  | A(x)+B(x)=2x^5+3x^2+5x+2 | 同左 |
|  |  | A(x)\*B(x)=6x^7+4x^6+2x^5+9x^3+6x^2+5x+1 | 同左 |
|  |  | A(2)=17 | 17 |

### 測試案例二
| 測試案例 | 輸入參數 | 預期輸出 | 實際輸出 |
|---|---|---|---|
| 測試二 | A: 3 項 → (2,3)、(-4,1)、(3,0)<br>B: 3 項 → (1,2)、(-2,1)、(1,0) | A(x)=2x^3-4x+3<br>B(x)=x^2-2x+1 | 同左 |
|  |  | A(x)+B(x)=2x^3+x^2-6x+4 | 同左 |
|  |  | A(x)\*B(x)=2x^5-4x^4+7x^3-11x^2+10x+3 | 同左 |
|  |  | A(1)=1 | 1 |
